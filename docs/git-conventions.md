...
- A useful structure is: current situation, why it should change, the imperative change being made, why that approach was chosen, and any other relevant context.
